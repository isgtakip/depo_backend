...
class StokHareketleri extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        //
        Schema::create('stok-hareketleri', function (Blueprint $table) {
                    $table->id('hareket_id');
    ...
    {
        //
        Schema::dropIfExists('stok-hareketleri');
    }
}
